...
st.set_page_config(page_title="Gestion de eventos escolares", layout="wide")
st.title("🏫 Gestion de eventos escolares")
...
API_ENDPOINTS = {
    ...
    "profesror" : "https://eventos-25.onrender.com/api/profesores",
